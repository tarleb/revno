...
describe('module revno', function ()
  ...
  describe('strict item', function ()
    it('can be converted to a string', function ()
      local para = pandoc.Para('moin')
      local spara = revno.tostrict(para)
      assert.is_string(tostring(spara))
    end)
    it('has the same string representation as the lazy object', function ()
      local para = pandoc.Para('moin')
      local spara = revno.tostrict(para)
      assert.equals(tostring(para), tostring(spara))
    end)
  end)
end)
